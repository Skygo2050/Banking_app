...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/sparkLogo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="statics/sparkLogo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/sparkLogo.png">
...
<div id="container">
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#03fc84;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center; color:black;"><b>Welcome to <br> Sparks
                        Bank!</b></p>
            </div>
